#this is originally copied from K4ys4r
#https://github.com/K4ys4r/VASP_Scripts/blob/master/OSZICAR_MD_Plot/Plot_OSZICAR_MD.py
#https://github.com/K4ys4r/VASP_Scripts
#*************************************************************************************#
...
while PLOT:
      ...
      Xplot="Steps"
      Yplot=input("Yplot (T, E, F, E0, EK, SP, SK or md_data) > ")
      if (Xplot in OSZ_Labels) and (Yplot in OSZ_Labels):
         PLOT_DATA(OSZ,Xplot,Yplot)
      elif Yplot:
          p.savetxt('md_data',OSZ,fmt='%10.16f')
      else:
